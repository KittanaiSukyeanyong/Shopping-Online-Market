<template>
  <div id="app">
    ...
    <div class="container" style="width: 1500px">
			...
			<img class="pageBanner" src="http://kroel-acoustic.com/wp-content/uploads/2014/08/audio-technica-logo.jpg"  >
			</div>
      <div class="" style="margin-top:20px">
        <br>
...
var config = {
  apiKey: 'AIzaSyBOXoNyWIZ7h1NtRJRUZ1-5N3v33rbmZmg',
  authDomain: 'marketweb-beda6.firebaseapp.com',
  databaseURL: 'https://marketweb-beda6.firebaseio.com',
  projectId: 'marketweb-beda6',
  storageBucket: 'marketweb-beda6.appspot.com',
  messagingSenderId: '871909609790'
}
